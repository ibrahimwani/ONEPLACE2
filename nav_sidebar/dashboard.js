document
  .getElementById("home")
  .addEventListener("click", () => showContent("home"));
document
  .getElementById("courses")
  .addEventListener("click", () => showContent("courses"));
document
  .getElementById("grades")
  .addEventListener("click", () => showContent("grades"));
document
  .getElementById("archive")
  .addEventListener("click", () => showContent("archive"));
document
  .getElementById("institute")
  .addEventListener("click", () => showContent("institute"));
document
  .getElementById("settings")
  .addEventListener("click", () => showContent("settings"));
document
  .getElementById("logout")
  .addEventListener("click", () => showContent("logout"));
...
function addChapters() {
  ...
  Chapters.innerHTML = "YOu clicked me";
  const coursesContent = document.querySelector(".coursesContainer");
  coursesContent.innerHTML = `
  <div class="dashboard-cards">
    <div class="card cardChapters">
      <h3> Python</h3>
      <p>Learn the basics of programming using Python and Java.</p>
    </div>
    <div class="card cardChapters">
      <h3>Cpi</h3>
      <p>Understand essential data structures and algorithms.</p>
    </div>
    <div class="card cardChapters">
      <h3>Machine Learning</h3>
      <p>Dive into the basics of Machine Learning and its applications.</p>
    </div>
    <div class="card cardChapters">
      <h3>Web Development Basics</h3>
      <p>Explore the fundamentals of HTML, CSS, and JavaScript.</p>
    </div>
  </div>
`;
}
...
document
  ...
  .addEventListener("click", goToProfileAndToggleDropdown);
document
  .getElementById("selectInstituteBtn")
  .addEventListener("click", selectInstitute);
